...
/check proves the work behaves as promised. This skill reviews the code itself.
...
Scope and lens are separate, and may appear in either order: `/audit security current`,
`/audit src/auth tests`.
...
`religion/context/findings.md` is the durable record. Chat does not survive a cleared
