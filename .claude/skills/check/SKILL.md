...
Read `religion/context/current-work.md` and take the stated outcome from every build step,
...
- next action: /implement when something failed, /complete when everything
  passed
