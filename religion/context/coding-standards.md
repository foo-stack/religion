...
> the bottom are written by `setup` from what this project actually does, and are
...
Empty until `setup` detects the stack and writes this section: language conventions,
